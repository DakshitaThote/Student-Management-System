...
<html>
	...
	<!-- first batch demotion -->
		...
		<!-- Wrapper -->
			<div id="wrapper">
				<div class = "logout">
					<a href = "Logout"><img src= "images/lout.png" width="30px" height="33px"></a>
				</div>
				<!-- Header -->
					<header id="header">
						<div class="logo">
								...
								<form action="AddStudent" method="post">
									...
									<div class="fields">
										...
										<div class="field half">
											...
											<input type="tel" name="mobile" id="mobileNumber" placeholder="985 956 8562" maxlength = 10 pattern="[0-9]{3}[0-9]{3}[0-9]{4}" required/>
										</div>
										<div class="field half">
											<label for="fees">Fees</label>
											<input type="text" name="fees" id="fees" placeholder="12,000" required/>
										</div>
										<div class="field half">
										...
										<div class="field half">
											...
											<input type="text" name="highestQualification" id="name" placeholder="MCA in 2022" required/>
										</div>
										<div class="field half">
											<label for="exprience">Previous Experience</label>
											<input type="text" name="previousExperience" id="name" placeholder="2 Years" required/>
										</div>
										<div class="field half">
		...
		<!-- Promote confirmation -->
			<script>
			    function confirmPromote(id) {
			        var confirmation = window.confirm("Are you sure you want to promote?");
		...
		<!-- Demote confirmation -->
			<script>
			    function confirmDemote(id) {
			        var confirmation = window.confirm("Are you sure you want to demote?");
