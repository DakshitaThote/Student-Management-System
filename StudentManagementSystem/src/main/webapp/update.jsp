	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
							...
							<form action="Update" method="post">
									...
									<div class="fields">
										...
										<div class="field half">
											...
											<input type="text" name="name" id="name" value="<% out.print(stName); %>" required/>
										</div>
										<div class="field half">
											<label for="mobile">Mobile Number</label>
											<input type="tel" name="mobile" value="<% out.print(stContact); %>" id="mobileNumber" maxlength = 10 required/>
										</div>
										<div class="field half">
											<label for="fees">Fees</label>
											<input type="text" name="fees"value="<% out.print(stFees); %>" id="fees" required/>
										</div>
										<div class="field half">
											<label for="location">Location</label>
											<input type="text" name="location" value="<% out.print(stLocation); %>" id="name" required/>
										</div>
										<div class="field half">
											<label for="qualification">Highest Qualification</label>
											<input type="text" name="highestQualification" value="<% out.print(stQualification); %>" id="name" required/>
										</div>
										<div class="field half">
											<label for="exprience">Previous Experience</label>
											<input type="text" name="previousExperience" value="<% out.print(stExperience); %>" id="name" required/>
										</div>
										<div class="field half">
											<label for="group">Group</label>
											<select name = "group" id = "group"required>
												<option><% out.print(stGroup); %></option>
										...
										<div class="field half">
											<label for="mockScore">Mock Score</label>
											<select name = "mockScore" id = "group" required>
												<option><% out.print(stMockScore); %></option>
				...
				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">&copy; 2021-2024 Powerd by <a href="https://taskryt.com/">TASKRYT.COM</a>.</p>
					</footer>
